...
public class base {
	...
	public WebDriver initializeDriver() throws IOException {
		 ...
		 p=new Properties();
		FileInputStream fis=new FileInputStream("D:\\selinium\\cucumber\\TideProject\\testdata\\configure.properties");
		p.load(fis);
		...
		if(browserName.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "D:\\selinium\\cucumber\\TideProject\\driver\\chromedriver.exe");
			 driver = new ChromeDriver();
			
			
		}
		else if(browserName.equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.chrome.driver", "D:\\selinium\\cucumber\\TideProject\\driver\\geckodriver.exe");
			 driver = new FirefoxDriver();
			
			
		}else if(browserName.equalsIgnoreCase("edge")){
			System.setProperty("webdriver.chrome.driver", "D:\\selinium\\cucumber\\TideProject\\driver\\msedgedriver.exe");
